...
public final class RobotInstructions {
	...
	// e. g. send <robot> 1 <distance> 0
	public static final byte MOVE = 1;
	
	// e. g. send <robot> 2 <heading high> <heading low>
	public static final byte ROTATE = 2;
	
	// e. g. send <robot> 3 0 0
	public static final byte KICK = 3;
	
	// e. g. send <robot> 4 <distance> 0
	public static final byte LAT_MOVE = 4;
	
	/* e. g. "send a <robot> 4 10 5" (set track width to 105 mm, only for attacker)*/
	public static final byte SET_TRACK_WIDTH = 5;
	
	/* e. g. "send <robot> 5 75 0" (set travel speed to 75% of max capacity)*/
	public static final byte SET_TRAVEL_SPEED = 6;
	
	/* e. g. "send <robot> 6 75 0" (set rotate speed to 75% of max capacity)*/
